...
img50new[,,1]<-matrix(don$r,nrow = 256,byrow = TRUE)
img50new[,,2]<-matrix(don$g,nrow = 256,byrow = TRUE)
img50new[,,3]<-matrix(don$b,nrow = 256,byrow = TRUE)
display(img50)
display(img50new)
display(img100)
